  ...
  return (<>
    <MaxWidthWrapper>
      <div className='py-20 mx-auto text-center flex flex-col items-center max-w-3xl'>
        ...
        <p className='mt-6 text-lg max-w-prose text-muted-foreground'>Welcome to DigiAssetsHub. Every asset on our platform is verified by our team to ensure our highest quality standards</p>
